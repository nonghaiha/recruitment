                ...
                <div class="menu close">
                    ...
                    <div class="item-link mb" style="background: #111; height: 60px">
                        <i aria-label="icon: close-square" style="font-size: 30px; color: #fff"
                            class="anticon anticon-close-square"><svg viewBox="64 64 896 896" focusable="false" class=""
                                data-icon="close-square" width="1em" height="1em" fill="currentColor"
                                aria-hidden="true">
                                <path
